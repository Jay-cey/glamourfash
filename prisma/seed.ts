      ...
      data: {
        ...
        reviews: {
          create: [
            {
              rating: 5,
              comment: "Absolutely in love with this! The quality is amazing.",
              author: "Sarah M."
            },
            {
              rating: 4,
              comment: "Fits well, true to size. Fast shipping too.",
              author: "Jessica K."
            },
            {
              rating: 5,
              comment: "Perfect for the occasion. Received so many compliments!",
              author: "Emily R."
            }
          ]
        }
