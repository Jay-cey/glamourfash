        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 text-center border-b border-gray-100">
            ...
            <p className="text-gray-500">
              Thank you for your purchase. Your order ID is <span className="font-mono font-medium text-black">#{lastOrder.id}</span>
            </p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-8 border-t border-gray-100 pt-8">
              <dl className="space-y-4 text-sm">
                ...
                <div className="flex justify-between text-gray-600">
                  <dt>Shipping</dt>
                  <dd>{lastOrder.shipping === 0 ? "Free" : `$${lastOrder.shipping.toFixed(2)}`}</dd>
                </div>
                <div className="flex justify-between items-center border-t border-gray-100 pt-4">
                  <dt className="text-base font-medium text-gray-900">Total</dt>
                  <dd className="text-xl font-bold text-gray-900">${lastOrder.total.toFixed(2)}</dd>
                </div>
              </dl>
            </div>
          </div>
